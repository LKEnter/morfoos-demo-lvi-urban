...
export const IMAGES = {
  ...
  /** Smaller sources for TrustIntro grid cells (~380px wide) */
  trustGrid: [
    unsplash("photo-1676210134050-6f12c6898395", 760),
    unsplash("photo-1733426107854-ee00a25d72a7", 760),
    unsplash("photo-1776860155275-eee24bfb1dee", 760),
  ],
} as const;
